...
public abstract interface NoticeDao {
    ...
    @org.jetbrains.annotations.Nullable()
    @androidx.room.Insert(onConflict = androidx.room.OnConflictStrategy.REPLACE)
    public abstract java.lang.Object insertUniqueNotice(@org.jetbrains.annotations.NotNull()
    com.yzdev.mobiletest.domain.model.entities.NoticeEntity noticeList, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super kotlin.Unit> continuation);
    ...
    public abstract java.lang.Object getNotice(int id, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super com.yzdev.mobiletest.domain.model.entities.NoticeEntity> continuation);
    
    @org.jetbrains.annotations.Nullable()
    @androidx.room.Query(value = "SELECT * FROM NoticeTable WHERE story_id = :code")
    public abstract java.lang.Object getNoticeByCode(@org.jetbrains.annotations.NotNull()
